...
def main(img): 
    ...
    #用python系统读取方法
    f = open(img,'rb')
    img2 = base64.b64encode(f.read())   #得到API可以识别的字符串
    ...
    # img2 = base64.b64encode(data_encode)    #得到API可以识别的字符串

    params = get_params(img2)    #获取鉴权签名并获取请求参数
    url = "https://api.ai.qq.com/fcgi-bin/ptu/ptu_faceage"  # 人脸分析
